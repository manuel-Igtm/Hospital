...
class PatientAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identification", {"fields": ("id", "mrn", "ssn_masked")}),
        ("Personal Information", {"fields": ("first_name", "middle_name", "last_name", "date_of_birth", "gender")}),
        ("Contact", {"fields": ("phone", "email")}),
        ("Address", {"fields": ("address_line1", "address_line2", "city", "state", "postal_code", "country")}),
        ("Medical", {"fields": ("blood_type", "allergies")}),
        (
            "Emergency Contact",

...
from apps.core.utils import aes_gcm_encrypt, aes_gcm_decrypt
...
class Patient(models.Model):
    ...
    _ssn_encrypted = models.BinaryField(
        null=True,
        blank=True,
        help_text='Encrypted SSN (AES-256-GCM)'
    )
    ...
    ssn_hash = models.CharField(
        ...
        blank=True,
        db_index=True,
        help_text='SHA-256 hash of SSN for lookups'
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text='Whether patient record is active'
    )
    
    # Timestamps
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text='When the patient was registered'
    )
    updated_at = models.DateTimeField(
        auto_now=True,
        help_text='When the patient record was last updated'
    )

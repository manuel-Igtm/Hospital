...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    id = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False, help_text="Unique identifier for the user"
    )
    email = models.EmailField(unique=True, validators=[EmailValidator()], help_text="Email address (used for login)")
    ...
    # Timestamps
    date_joined = models.DateTimeField(default=timezone.now, help_text="Date and time when user was created")
    ...
    def can_view_patients(self):
        ...
        return self.role in [UserRole.ADMIN, UserRole.DOCTOR, UserRole.NURSE, UserRole.LAB_TECH, UserRole.RECEPTIONIST]

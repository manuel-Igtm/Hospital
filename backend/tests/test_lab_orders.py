...
from apps.lab_orders.models import (
    ...
    LabOrder, OrderStatus, OrderPriority,
    LabResult,
)
...
class TestLabOrderAPI:
    ...
    def test_lab_tech_cannot_create_order(
        self, authenticated_lab_tech_client, sample_patient, test_type
    ):
        ...
        response = authenticated_lab_tech_client.post(
            '/api/v1/lab/orders/',
            order_data,
            format='json'
        )
    ...
    def test_collect_specimen(self, authenticated_nurse_client, lab_order):
        ...
        response = authenticated_nurse_client.post(
            f'/api/v1/lab/orders/{lab_order.id}/collect_specimen/'
        )
    ...
    def test_cancel_order(self, authenticated_doctor_client, lab_order):
        """Test cancelling an order."""
        response = authenticated_doctor_client.post(
            f'/api/v1/lab/orders/{lab_order.id}/cancel/'
        )
    ...
    def test_pending_results_endpoint(self, authenticated_lab_tech_client, lab_order):
        ...
        response = authenticated_lab_tech_client.get(
            '/api/v1/lab/orders/pending_results/'
        )
...
class TestLabResultAPI:
    ...
    def test_doctor_cannot_create_result(
        self, authenticated_doctor_client, lab_order
    ):
...
class TestTestTypeAPI:
    ...
    def test_create_test_type_admin_only(
        self, authenticated_admin_client, authenticated_doctor_client
    ):
        ...
        test_data['code'] = 'UA2'
        doctor_response = authenticated_doctor_client.post(
            '/api/v1/lab/test-types/',
            test_data,
            format='json'
        )

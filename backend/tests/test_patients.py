...
from apps.patients.models import Patient, Gender, BloodType
...
class TestPatientAPI:
    ...
    def test_retrieve_patient(self, authenticated_doctor_client, sample_patient):
        ...
        response = authenticated_doctor_client.get(
    ...
    def test_deactivate_patient_admin_only(
        ...
        doctor_response = authenticated_doctor_client.delete(
            f'/api/v1/patients/{sample_patient.id}/'
        )
        assert doctor_response.status_code == 403
        
        # Admin can deactivate
        admin_response = authenticated_admin_client.delete(
            f'/api/v1/patients/{sample_patient.id}/'
        )

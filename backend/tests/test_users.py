...
class TestAuthEndpoints:
    ...
    def test_login_success(self, api_client, admin_user):
        ...
        response = api_client.post(
            "/api/v1/auth/login/", {"email": "admin@hospital.test", "password": "AdminPass123!"}, format="json"
        )
    ...
    def test_login_invalid_credentials(self, api_client, admin_user):
        ...
        response = api_client.post(
            "/api/v1/auth/login/", {"email": "admin@hospital.test", "password": "wrongpassword"}, format="json"
        )
    ...
    def test_logout(self, authenticated_admin_client, admin_user, api_client):
        ...
        # Logout
        response = authenticated_admin_client.post("/api/v1/auth/logout/", {"refresh": refresh_token}, format="json")
...
class TestUserViewSet:
    ...
    def test_create_user_admin_only(self, authenticated_admin_client, authenticated_doctor_client):
        ...
        admin_response = authenticated_admin_client.post("/api/v1/users/", user_data, format="json")
    ...
    def test_deactivate_user(self, authenticated_admin_client, doctor_user):
        ...
        response = authenticated_admin_client.delete(f"/api/v1/users/{doctor_user.id}/")
    ...
    def test_cannot_deactivate_self(self, authenticated_admin_client, admin_user):
        ...
        response = authenticated_admin_client.delete(f"/api/v1/users/{admin_user.id}/")
